...
export default function CodeLabController($window, $mdSidenav, toast, scriptService, userService, deviceService, $translate, $mdDialog, $document, $rootScope, $scope, $stateParams, $state, store, $mdBottomSheet, $timeout, settings, $log) {
	...
	function changeMode($event) {
		if (vm.script.mode === 'python') {
			...
			// $window.globalWidgetDemand = [];
			// $window.globalChannelCounter = 255;
	...
	function requestWidget(widgetDict) {


		var jsonBody = {

			"email": vm.userDisplayName,
			"password": store.get('jwt_token'),
			"type": "email",
			"widgets": widgetDict.slice()
		};
		$log.error("DEMAND", jsonBody);
		return fetch('https://blynk.getblocky.com:100/dashboard', {
				headers: {
					'Content-Type': 'application/json'
				},
				method: "POST",
				body: angular.toJson(jsonBody)
			})
			.then(function () {
	...
	function uploadScript() {
		...
		// Beta of Advance API
		requestWidget($window.globalWidgetDemand);
	...
	function md5(r) {
		...
		function o(r, o, e, u, a, f, i) {
			var C;
			return t(n(r = t(r, t(t((C = o) & e | ~C & u, a), i)), f), o)
		}

		function e(r, o, e, u, a, f, i) {
			var C;
			return t(n(r = t(r, t(t(o & (C = u) | e & ~C, a), i)), f), o)
		}

		function u(r, o, e, u, a, f, i) {
			return t(n(r = t(r, t(t(o ^ e ^ u, a), i)), f), o)
		}

		function a(r, o, e, u, a, f, i) {
			return t(n(r = t(r, t(t(e ^ (o | ~u), a), i)), f), o)
		}
