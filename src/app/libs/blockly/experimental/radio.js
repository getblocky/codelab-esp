...
Blockly.Blocks['rfreceiver-event'] = {
	init: function() {
		this.appendDummyInput('MAIN')
			.appendField("when pressing key")
			.appendField(new Blockly.FieldDropdown([["A","A"],["B","B"],["C","C"],["D","D"]]),"KEY")
			.appendField('of Remote')
			.appendField(new Blockly.FieldTextInput('01F01F01') , 'ID')
			.appendField('on')
...
Blockly.Python['rfreceiver-event'] = function(block) {
	...
	var function_name = 'Event_' + port + '_' + id  + '_' + key ;
	...
	AddToSection('event' , object  + ".event(address='" + id + "',key='" + key + "',function="+function_name+")\n");
