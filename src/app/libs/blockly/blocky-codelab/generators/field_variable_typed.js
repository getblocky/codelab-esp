...
goog.provide('Blockly.TypedFieldVariable');
...
Blockly.TypedFieldVariable = function(varname, type, createVar, opt_changeHandler) {
  ...
  if (opt_changeHandler) {
    ...
    changeHandler = function(value) {
      var retVal = Blockly.TypedFieldVariable.dropdownChange.call(thisObj, value);
      var newVal;
      if (retVal === undefined) {
    ...
    changeHandler = Blockly.TypedFieldVariable.dropdownChange;
  }

  Blockly.TypedFieldVariable.superClass_.constructor.call(this,
      Blockly.TypedFieldVariable.dropdownCreate, changeHandler);
 ...
 * @return {!Blockly.TypedFieldVariable} The result of calling the constructor again
 *   with the current values of the arguments used during construction.
 */
Blockly.TypedFieldVariable.prototype.clone = function() {
  return new Blockly.TypedFieldVariable(this.getValue(), this.changeHandler_);
};
 ...
 */
Blockly.TypedFieldVariable.prototype.getValue = function() {
  return this.getText();
};
 ...
 */
Blockly.TypedFieldVariable.prototype.setValue = function(text) {
  this.value_ = text;
  this.setText(text);
};
...
Blockly.TypedFieldVariable.dropdownCreate = function() {
  var variableList = Blockly.Variables.getVariablesOfType(this.vartype);
 ...
 * @this {!Blockly.TypedFieldVariable}
 */
Blockly.TypedFieldVariable.dropdownChange = function(text) {
